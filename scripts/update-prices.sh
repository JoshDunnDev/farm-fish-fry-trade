...
echo "🏷️  FarmFishFryTrade - Price Update Tool"
echo ""
...
echo "✏️  Edit the pricing file now, then press Enter to continue..."
echo "   You can:"
...
if [ $? -eq 0 ]; then
    ...
    echo "❌ Failed to reach the reload API"
    echo "   URL: $API_URL"
    echo "   Check that:"
    ...
    echo ""
    echo "ℹ️  Note: Changes will still auto-reload within 30 seconds"
fi
